...
def replicas = "1"
def devProject = "arijitmaitidonube-dev" // TODO: Your dev project name goes here
def testProject = "arijitmaitidonube-test" // TODO: Your test project name goes here
def prodProject = "arijitmaitidonube-prod" // TODO: Your prod project name goes here
        ...
        stage("Setup") {
            steps {
                script {
                    openshift.withCluster(){
                    echo "in script"
                    openshift.withProject("arijitmaitidonube-dev") {
